/* 음악 태그 삭제 */
	...
	/* Test Case */
	DELETE FROM music_tag WHERE music_id = 'member1-music 1' AND music_tag_contents = '태그1-1';
	DELETE FROM music_tag WHERE music_id = 'member1-2-music 2';
	DELETE FROM music_tag WHERE music_id = 'member2-music 1' ;